...
public class ToolsFunctionality extends BaseClass {
	
  /*@BeforeClass
  public void beforeClass() throws InterruptedException, AWTException {

      // Initialize WebDriver with ChromeOptions
    //  System.setProperty("webdriver.chrome.river", "path/to/chromedriver");
...
//
//	        // Allow microphone access by pressing 'Tab' and 'Enter' keys
//	        robot.keyPress(KeyEvent.VK_TAB);
//	        robot.keyRelease(KeyEvent.VK_TAB);
//	        robot.delay(3000); // Delay to allow UI to catch up
...
//================================================
   ...
   public void testDefaultSelectedCheckBox() throws Exception 
   {
	   ...
	   {
		   softAssert.assertTrue(Checkbox.isSelected(), "Checkbox should be checked after clicking");
	   }
   ...
   public void testCheckboxIsChecked() throws InterruptedException {
	   ...
	   SoftAssert softAssert = new SoftAssert();
	   Thread.sleep(3000);
       WebElement checkbox = driver.findElement(By.xpath("//span[@class = 'main_ch_mr Itc-checkmark']"));  // Replace with the actual ID of your checkbox
       checkbox.click();
	   Thread.sleep(3000);
       // Verify the checkbox is unchecked initially
       softAssert.assertFalse(checkbox.isSelected(), "Checkbox should be unchecked initially");
       Thread.sleep(3000);
       // Check the checkbox
...
//       wait.until(ExpectedConditions.elementToBeClickable(checkbox));
       ...
       // Click the checkbox
       WebElement checkbox1 = driver.findElement(By.xpath("//span[@class = 'main_ch_mr Itc-checkmark']"));  // Replace with the actual ID of your checkbox
       checkbox1.click();
       
       Thread.sleep(3000);
       // Verify the checkbox is checked after clicking
       softAssert.assertFalse(checkbox1.isSelected(), "Checkbox should be checked after clicking");
       softAssert.assertAll();
   }
   ...
   public void testPbxLinkClick() throws InterruptedException {
	   ...
	   softAssert.assertEquals(Actual23, Expected23); 
	   Thread.sleep(3000);
       ...
       softAssert.assertEquals(actual1, currentUrl);
       Thread.sleep(3000);
       driver.navigate().back();
       softAssert.assertAll();
      // softAssert.assertTrue(currentUrl.contains("expected_destination"), "Unexpected URL after clicking the link");
   }
   @Test(priority=7)
   public void testForgotLinkClick1() throws InterruptedException {
       ...
       link.click();
       Thread.sleep(1000);
       String ExpForgotPasscodetext = "Forgot your password?";
	   String ActForgotPasscodetext = driver.findElement(By.xpath("//*[contains(text(),'Forgot your password?')]")).getText();
	   softAssert.assertEquals(ExpForgotPasscodetext, ActForgotPasscodetext);
	   
       Thread.sleep(1000);
       String Exptext = "We’ll send you a link to reset your password";
	   String Acttext = driver.findElement(By.xpath("//*[contains(text(),'We’ll send you a link to reset your password')]")).getText();
	   softAssert.assertEquals(Exptext, Acttext);
       ...
       String Actual23 = "Please enter Email.";
	   String Expected23 = driver.findElement(By.xpath("//*[contains(text(),'Please enter Email.')]")).getText();
	   softAssert.assertEquals(Actual23, Expected23);
	   
       Thread.sleep(3000);
       
       driver.findElement(By.id("txtLostEmail")).sendKeys("Singanaboina");
       Thread.sleep(2000);
       driver.findElement(By.id("btnSubmit")).click();
       String ExpectedforGotpasscode = "Please enter a valid Email.";
	   String ActualforGotpasscode = driver.findElement(By.xpath("//*[contains(text(),'Please enter a valid Email.')]")).getText();
	   softAssert.assertEquals(ExpectedforGotpasscode, ActualforGotpasscode);
	   Thread.sleep(2000);
	   driver.findElement(By.id("txtLostEmail")).clear();
	   Thread.sleep(3000);
	   
	   driver.findElement(By.id("txtLostEmail")).sendKeys("Singanaboina.suresh@coanetwork.com");
       Thread.sleep(2000);
       
       driver.findElement(By.id("btnSubmit")).click();
       String Expactcheck = "Check your Email";
	   String actcheck = driver.findElement(By.xpath("//*[contains(text(),'Check your Email')]")).getText();
	   softAssert.assertEquals(Expactcheck, actcheck);
	   Thread.sleep(2000);
	   String Exppasscodesent = "Your passcode has been sent to your Email.";
	   String Actpasscodesent = driver.findElement(By.xpath("//*[contains(text(),'Your passcode has been sent to your Email.')]")).getText();
	   softAssert.assertEquals(Exppasscodesent, Actpasscodesent);
	   Thread.sleep(2000);
	   
	   String extURl = "https://www.coasecure.com/";
	   String ActUrl = driver.getCurrentUrl();
	   softAssert.assertEquals(extURl, ActUrl);
	   Thread.sleep(2000);
	   driver.findElement(By.name("btnReLogin")).click();
	  
	   softAssert.assertAll();  // softAssert.assertTrue(currentUrl.contains("expected_destination"), "Unexpected URL after clicking the link");
   }
   @Test(priority=8)
   ...
   public void itcLogoVisibility() {
       ...
       softAssert.assertTrue(logo.isDisplayed(), "Logo should be visible on the page");
       softAssert.assertAll();
   }
   @Test (priority=10)
   public void testContactUsInformation() throws InterruptedException {
	   SoftAssert softAssert = new SoftAssert();
       // Locate the logo element
    /*   WebElement contactus  = driver.findElement(By.xpath("//*[contains(text(),'Contact us')]"));  // Replace with the actual ID or other locator of your logo
       contactus.click();
...
public void recordingWithMic() throws Exception {
    ...
    // Verify that the logo is visible on the page
    softAssert.assertTrue(logo.isDisplayed(), "Recording should be visible on the page");
    ...
    softAssert.assertEquals(Actualresult, extresult);
    ...
    softAssert.assertEquals(Actualresult1, extresult1);
    ...
    softAssert.assertTrue(isEnabled, "Button is not enabled");
...
{
	SoftAssert softAssert = new SoftAssert();
	   WebElement imageElement = driver.findElement(By.xpath("//*[contains(@id, 'btnAddContact')]")); // Modify the XPath accordingly
...
//     softAssert.assertEquals(itemCount, expectedItemCount);
	  ...
	  {
		  driver.findElements(By.xpath("//a[contains(text(),'Next')]"));
	  }
	  Thread.sleep(3000);
...
public void testImportandExportfunctionality() throws InterruptedException
{
	...
	String filepath = "C:\\Users\\Singanaboina Suresh\\Downloads\\8446247684_Contacts.csv";
	Thread.sleep(3000);
	...
	((JavascriptExecutor) driver).executeScript("window.scrollBy(0,750)");
	   ...
	   String ExpectedSTstatus = "Listen to Converted Greeting";
	      ...
	      // Find the checkbox element by its locator (for example, by id, class name, etc.)
	        WebElement checkboxElement = driver.findElement(By.xpath("//label[contains(text(),'Activate TTS Greeting')]"));
...
public void afterClass() throws EmailException {
	  ...
	  attachment.setPath("C:\\Testng\\test-output\\emailable-report.html");
	  ...
	  email.addTo("singanaboina.suresh@coanetwork.com", "John Doe");
	  email.setFrom("singanaboina.suresh@coanetwork.com", "Test results has been attached");
