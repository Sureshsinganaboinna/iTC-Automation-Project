...
public class messageNotifications {
	...
	if(driver.findElements(By.xpath("//*[@checked='checked' and @id = 'chkEmail2Notify']")).size()>0)
	{
	  ...
	  public void afterClass() throws Exception {
		  ...
		  prop.load(new FileInputStream("C:\\Spring\\eclipse-workspace\\iTCbackoffice1\\configs\\Configuation.properties.txt"));
		  String attachments = "C:\\Spring\\eclipse-workspace\\iTCbackoffice1\\test-output\\emailable-report.html";
		  //attachments.add("C:\\Spring\\eclipse-workspace\\iTCbackoffice1\\test-output\\emailable-report.html");
		  emailutils.sendUsingSMTP(prop, "Test Execution result", "Hi Team Execution is succesfull", attachments);
		 // emailutils.sendUsingSMTP(prop, "Test Execution result", "Hi Team Execution is succesfull", attachments);
