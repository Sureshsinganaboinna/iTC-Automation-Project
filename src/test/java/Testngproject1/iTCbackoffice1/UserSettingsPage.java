...
public class UserSettingsPage {
  ...
  public void f() throws InterruptedException {
      ...
      Assert.assertEquals(defaultSelectedOption, "Eastern");
      Thread.sleep(2000);
      ...
      Assert.assertEquals(selectedOption1, "Eastern");
      Thread.sleep(2000);
  ...
  /*    String Expectedresult11 = "(844) 624-7684";
      ...
      if(Phonenumberprasent.equals(Expectedresult11))
      {
          ...
          Assert.assertEquals(actualresult11, Expectedresult12);
          ...
          Assert.assertEquals(actualresult111, Expectedresult111);
      }
     ...
     Assert.assertEquals(actualresult11111, Expectedresult111111);
     Thread.sleep(3000);
     ...
     Assert.assertEquals(actualresult111111, Expectedresult1111111);
     ...
     Assert.assertEquals(actualresult1111111, Expectedresult11111111);
     Thread.sleep(3000);
     ...
     Assert.assertEquals(actualresult11111111, Expectedresult111111111);
     ...
     Assert.assertEquals(actualresult111111111, Expectedresult1111111111);
     ...
     Assert.assertEquals(actualresult1111111111, Expectedresult11111111111);
     ...
     Assert.assertEquals(actualresult11111111111, Expectedresult111111111111);
     ...
     Assert.assertEquals(actualresult111111111111, Expectedresult1111111111111);
     Thread.sleep(3000);
     ...
     Assert.assertEquals(actualresult1111111111111, Expectedresult11111111111111);
     Thread.sleep(3000);
     ...
     Assert.assertEquals(actualresult11111111111111, Expectedresult111111111111111);
     ...
     Assert.assertEquals(actualresult111111111111111, Expectedresult1111111111111111);
     ...
     Assert.assertEquals(actualresult1111111111111111, Expectedresult11111111111111111);
     ...
     Assert.assertTrue(defaultSelectedRadio.isSelected(), "Default selected radio button is not selected");
     
     
     
     // Verify the default selected state of a radio button
     WebElement defaultSelectedRadio1 = driver.findElement(By.xpath("//input[@id='rbCOAFAX' and @value='rbCOAFAX']"));
     Assert.assertFalse(defaultSelectedRadio1.isSelected(), "Default selected radio button is not selected");
     ...
     Assert.assertEquals(actualresult123, Expectedresult123);
     */
     // Verify the default selected state of a radio button
      if(driver.findElements(By.xpath("//input[@id='rbOldestFirst']")).size()>0) {
     WebElement defaultSelectedRadio11 = driver.findElement(By.xpath("//input[@id='rbOldestFirst']"));
     Assert.assertTrue(defaultSelectedRadio11.isSelected(), "Default selected radio button is not selected");
      }
     ...
     Assert.assertFalse(defaultSelectedRadio111.isSelected(), "Default selected radio button is not selected");
 	Thread.sleep(3000);
     WebElement relatedElement = driver.findElement(By.xpath("//label[@for='rbNewestFirst']"));
     relatedElement.click();
     Assert.assertTrue(relatedElement.isEnabled(), "Related element is still enabled after selecting radio option 2");
 	Thread.sleep(3000);
     WebElement relatedElement1 = driver.findElement(By.xpath("//label[@for='rbOldestFirst']"));
     relatedElement1.click();
     Assert.assertTrue(relatedElement1.isEnabled(), "Related element is still enabled after selecting radio option 2");
 	Thread.sleep(3000);
     ...
     Assert.assertEquals(actualresult1231, Expectedresult1231);
 	Thread.sleep(3000);
  ...
  ////////////////////////////////////////////////////   
     ...
     Assert.assertEquals(actualresult12311, Expectedresult12311);
 	Thread.sleep(2000);
 ...
 ////////////////////////////////////////////////////////////////////
     ...
     Assert.assertEquals(actualresult123111, Expectedresult123111);
 	Thread.sleep(2000);
    ...
    ////////////////////////////////////////////////////////////////////////////////////// 
     ...
     Assert.assertEquals(actualresult1231111, Expectedresult1231111);
 	Thread.sleep(2000);
    ...
    if(driver.findElements(By.xpath("//*[@id='divLeaveMsg']/div/label/div[@class='toggle btn btn-default off']")).size()>0)
    {
     ...
     Assert.assertEquals(actualresult155, Expectedresult155);
  	Thread.sleep(2000);
    ...
    if(Phonenumberprasent1.equals(Expectedresult188))
    {
        ...
        Assert.assertEquals(actualresult1556, Expectedresult1556);
        ...
        Assert.assertEquals(actualresult177, Expectedresult177);
    }
    ...
    if(AutoPhonenumber1.isEmpty())
    {
     ...
     Assert.assertEquals(actualresult144, Expectedresult144);
